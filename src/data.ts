...
export const initialMarketScores: MarketScoreItem[] = [
  {
    ...
    trafficLight: 'green',
    trafficLightLabel: '🟢 چراغ سبز (۸۴/۱۰۰) - بسیار قوی؛ شکست سقف تاریخی ۶ میلیون واحد و ورود پرحجم نقدینگی',
    primaryColor: '#10b981',
    metrics: [
      { label: 'ورود پول حقیقی:', value: '+۱,۴۸۰ میلیارد ت', status: 'positive' },
      { label: 'ارزش معاملات خرد:', value: '۱۶,۴۵۰ میلیارد ت', status: 'positive' },
      { label: 'شاخص کل:', value: '۶,۰۷۳,۲۹۴ (+۲.۰۳٪)', status: 'positive' },
      { label: 'قدرت خریدار:', value: '۱.۸۲ (سرانه بسیار قوی)', status: 'positive' },
    ],
    description: 'طبق فرمول ۱۰۰ امتیازی S1، ورود پرقدرت ۱,۴۸۰ میلیارد تومانی پول حقیقی و ارزش معاملات ۱۶.۴۵ همتی، تایید کامل چراغ سبز را محقق کرده است.',
    threeConfirmations: {
      criterion1: { name: 'ورود پول حقیقی (حداقل ۳ روز متوالی)', passed: true, note: '۳ روز پیوسته ورود پول سنگین به سهام شاخص‌ساز، صندوق‌های اهرمی و دلاری' },
      criterion2: { name: 'ارزش معاملات خرد (بیشتر از میانگین ۱ ماهه)', passed: true, note: '۱۶.۴۵ همت در برابر میانگین ماهانه ۷.۸ همت' },
      criterion3: { name: 'قدرت خریدار حقیقی (سرانه خرید به فروش > ۱)', passed: true, note: 'سرانه خرید ۶۴ م.ت در برابر سرانه فروش ۳۵ م.ت (نسبت ۱.۸۲)' },
      isConfirmed: true,
    },
    weightBreakdown: [
      { variable: 'ورود پول حقیقی (توالی ۳ روز)', weight: 30, scoreAchieved: 28, source: 'TSETMC / دیتابورس', evaluation: 'تایید ۳ روز متوالی با حجم مثبت' },
      { variable: 'ارزش معاملات خرد', weight: 20, scoreAchieved: 20, source: 'TSETMC / دیتابورس', evaluation: 'بیشتر از میانگین یک ماه گذشته' },
      { variable: 'قدرت خریدار حقیقی (سرانه خرید/فروش)', weight: 15, scoreAchieved: 14, source: 'دیتابورس / تریدرز آرنا', evaluation: 'نسبت ۱.۸۲ و بزرگتر از ۱' },
      { variable: 'اقتصاد کلان (نرخ بهره، ارز توافقی، کامودیتی)', weight: 20, scoreAchieved: 14, source: 'گزارش‌های رسمی اقتصادی', evaluation: 'گسترش بازار توافقی و ثبات نیما' },
      { variable: 'تحلیل تکنیکال (ابزار زمان‌بندی Timing)', weight: 10, scoreAchieved: 9, source: 'ره‌آورد ۳۶۵ / چارت زنده', evaluation: 'شکست سقف تاریخی با کندل پرقدرت' },
      { variable: 'اخبار سیاسی و محیطی', weight: 5, scoreAchieved: 3, source: 'خبرگزاری‌های رسمی معتبر', evaluation: 'آرامش نسبی محیطی' },
    ],
    details: {
      technicalScore: 90,
      fundamentalScore: 82,
      flowScore: 92,
      sentimentScore: 90,
      analysisSummary: 'شاخص کل با عبور از کانال ۶ میلیون واحد و تایید همزمان ۳ معیار مستقل، در وضعیت سوپربولیش قرار دارد.'
    }
  },
  {
    id: 'gold',
    ...
    primaryColor: '#ffb77d',
    metrics: [
      { label: 'انس جهانی طلا:', value: '۴,۶۰۷ دلار (تثبیت سقف)', status: 'positive' },
      { label: 'طلای ۱۸ عیار:', value: '۲۰,۴۰۰,۰۰۰ ت (+۲.۷۷٪)', status: 'positive' },
      { label: 'سکه امامی:', value: '۲۰۴,۵۰۰,۰۰۰ ت (حباب ۲.۷٪)', status: 'positive' },
    ...
    threeConfirmations: {
      criterion1: { name: 'روند صعودی اونس جهانی طلا', passed: true, note: 'تثبیت بالای ۴۶۰۰ دلار و حمایت بنیادین تقاضای بانک‌های مرکزی' },
      criterion2: { name: 'جریان پول ورودی به صندوق‌های طلا', passed: true, note: 'ورود مستمر پول به عیار، کهربا و زر در بورس کالا' },
      criterion3: { name: 'جهت حرکت دلار آزاد داخلی', passed: true, note: 'تثبیت دلار در محدوده ۱۹۱ هزار تومان' },
      isConfirmed: true,
    },
    weightBreakdown: [
      ...
      { variable: 'حباب سکه نسبت به ارزش ذاتی', weight: 20, scoreAchieved: 19, source: 'اتحادیه طلا و جواهر تهران', evaluation: 'حباب در محدوده کم‌ریسک ۲.۷٪' },
...
export const initialDailyInputs: InputMetric[] = [
  // Bourse (10 items)
  {
    ...
    weight: 0.15,
    lastUpdated: '17:05',
    description: 'تغییرات روزانه شاخص کل بورس تهران نسبت به روز معاملاتی قبل',
  ...
  },
  {
    ...
    weight: 0.20,
    lastUpdated: '17:15',
    description: 'حجم نقدینگی در گردش معاملات خرد بازار (بیش از ۴۶ همت)',
    source: 'دیتابورس / TSETMC',
  ...
  },
  {
    ...
    weight: 0.20,
    lastUpdated: '17:20',
    description: 'خالص ورود پول سرمایه‌گذاران حقیقی به سهام و صندوق‌ها',
  ...
  },
  {
    ...
    weight: 0.10,
    lastUpdated: '10:25',
    description: 'برتری قاطع ارزش صفوف تقاضا (۱۳.۸ همت خرید در برابر ۵۴۵ میلیارد فروش)',
  ...
  },
  {
    ...
    weight: 0.07,
    lastUpdated: '10:20',
    description: 'قدرت خریداران حقیقی (۶۴ م.ت در برابر ۳۵ م.ت)',
  ...
  },
  {
    ...
    weight: 0.20,
    lastUpdated: '17:10',
    description: 'درصد حباب قیمتی سکه امامی نسبت به ارزش ذاتی (حباب کم‌ریسک ۲.۵٪)',
