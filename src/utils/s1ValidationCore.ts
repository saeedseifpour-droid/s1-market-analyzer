...
export function getDefault13SectionsData(): StandardDailyInput13Sections {
  ...
  return {
    ...
    section1_iranMacro: {
      usdFree: '94,500 تومان',
      usdYesterday: '94,100 تومان',
      usdChangePct: '+0.42%',
      usdt: '94,800 تومان',
      usdtYesterday: '94,200 تومان',
      usdtChangePct: '+0.63%',
      gold18k: '8,450,000 تومان',
      gold18kYesterday: '8,380,000 تومان',
      gold18kChangePct: '+0.83%',
      sekeEmami: '95,200,000 تومان',
      sekeYesterday: '94,300,000 تومان',
      sekeChangePct: '+0.95%',
      coinBubble: '21.5%',
      econNews: 'تداوم عرضه ارز در بازار توافقی و ثبات نسبی در مرکز مبادله ایران',
    },
    section2_globalMarkets: {
      goldOunce: '2,925 دلار',
      ounceYesterday: '2,910 دلار',
      ounceChangePct: '+0.51%',
      dxy: '104.2',
      dxyChangePct: '-0.15%',
      brentOil: '76.4 دلار',
      ...
      vix: '14.2 واحد',
      vixChangePct: '-2.1%',
      globalFearGreed: '62 (طمع ملایم)',
      globalNews: 'انتظار بازارهای جهانی برای ثبات نرخ بهره فدرال رزرو و تقاضای مستمر طلای بانک‌های مرکزی',
    },
    section3_crypto: {
      btcPrice: '96,400 دلار',
      btcYesterday: '97,200 دلار',
      btcChangePct: '-0.82%',
      ethPrice: '2,740 دلار',
      ethChangePct: '-1.10%',
      btcDominance: '58.4%',
      marketCap: '3.25 تریلیون دلار',
      etfFlow: 'خروج نقدینگی',
      etfFlowAmount: '-35.0 میلیون دلار',
      fundingRate: '+0.008%',
      openInterest: '38.5 میلیارد دلار',
      cryptoFearGreed: '52 (خنثی)',
      cryptoNews: 'نوسان بیت‌کوین در کانال ۹۶ هزار دلار با ثبت خروج مقطعی از ETFهای اسپات',
    },
    section4_bourse: {
      tseIndex: '2,845,200 واحد',
      tseYesterday: '2,804,500 واحد',
      tseIndexChangePct: '+1.45%',
      tseEqualWeight: '842,100 واحد',
      tseEqualWeightChangePct: '+1.22%',
      retailVolume: '9,450 میلیارد تومان',
      realMoneyFlow: '+1,420 میلیارد تومان',
      positiveSymbolsCount: '542 نماد',
      negativeSymbolsCount: '238 نماد',
      buyQueueCount: '164 نماد',
      buyQueueValue: '1,850 میلیارد تومان',
      sellQueueCount: '32 نماد',
      sellQueueValue: '210 میلیارد تومان',
      marketNews: 'تداوم تقاضای قوی در گروه‌های دلاری و فلزات اساسی همراه با برتری قدرت خریداران حقیقی',
    },
    section5_afranFund: {
      closingPrice: '2,210 ریال',
      navPerUnit: '2,210 ریال',
      navDiffPct: '0.0%',
      volumeUnits: '1,250,000,000 واحد',
      valueBillionToman: '276 میلیارد تومان',
      moneyFlow: '+65 میلیارد تومان',
      perCapitaBuy: '72 میلیون تومان',
      perCapitaSell: '38 میلیون تومان',
      buyerPower: '1.89',
      aum: '24,500 میلیارد تومان',
    },
    section6_ayarFund: {
      closingPrice: '18,450 تومان',
      navPerUnit: '18,360 تومان',
      navDiffPct: '+0.49%',
      volumeUnits: '48,500,000 واحد',
      valueBillionToman: '895 میلیارد تومان',
      moneyFlow: '+145 میلیارد تومان',
      perCapitaBuy: '64 میلیون تومان',
      perCapitaSell: '41 میلیون تومان',
      buyerPower: '1.56',
      aum: '18,200 میلیارد تومان',
    },
    section7_khebarganFund: {
      closingPrice: '34,200 ریال',
      yesterdayPrice: '33,400 ریال',
      changePct: '+2.40%',
      navPerUnit: '34,500 ریال',
      navDiffPct: '-0.87%',
      volumeUnits: '28,000,000 واحد',
      valueBillionToman: '95.7 میلیارد تومان',
      moneyFlow: '+28 میلیارد تومان',
      perCapitaBuy: '52 میلیون تومان',
      perCapitaSell: '31 میلیون تومان',
      buyerPower: '1.68',
    },
    section8_tavanFund: {
      closingPrice: '24,800 ریال',
      navPerUnit: '24,950 ریال',
      navDiffPct: '-0.60%',
      volumeUnits: '92,000,000 واحد',
      valueBillionToman: '228 میلیارد تومان',
      moneyFlow: '+58 میلیارد تومان',
      perCapitaBuy: '58 میلیون تومان',
      perCapitaSell: '34 میلیون تومان',
      buyerPower: '1.71',
    },
    section9_otherGoldFunds: {
      ayar: '18,450 تومان (+0.49% حباب)',
      kahroba: '19,200 تومان (+0.40% حباب)',
      zar: '22,150 تومان (+0.55% حباب)',
      gohar: '15,400 تومان (+0.35% حباب)',
      nafis: '12,800 تومان (+0.42% حباب)',
      mesghal: '14,900 تومان (+0.50% حباب)',
    },
    section10_leveragedFunds: {
      ahrom: '23,500 ریال (+2.8%)',
      tavan: '24,800 ریال (+3.1%)',
      moj: '18,200 ریال (+2.4%)',
      shetab: '21,400 ریال (+2.7%)',
      bidar: '19,800 ریال (+2.9%)',
      jahesh: '26,200 ریال (+3.0%)',
      doX: '16,500 ریال (+2.5%)',
    },
    section11_silverFunds: {
      silver: '11,250 تومان (+1.2%)',
      noghrein: '10,800 تومان (+0.9%)',
      noghrabi: '12,100 تومان (+1.1%)',
    },
    section12_systematicRisks: {
      riskPolitical: 'سطح متوسط و تحت رصد',
      riskMilitary: 'آرامش نسبی بدون تنش جدید',
      riskEconomic: 'کنترل شکاف ارز آزاد و نیما',
      riskGlobal: 'تثبیت شاخص‌های نرخ بهره جهانی',
      riskCrypto: 'فشار مقطعی عرضه در آلتکوین‌ها',
      cbiDecisions: 'نرخ سود بین‌بانکی ۲۳.۸۵٪ و ادامه حراج مرکز مبادله',
      seoDecisions: 'تداوم نظارت بر بازارگردانی و دامنه نوسان استاندارد',
      domesticNews: 'عرضه ارز در بازار توافقی و گزارش‌های ماهانه شرکت‌های صادرات‌محور',
      internationalNews: 'گزارش‌های اشتغال آمریکا و تصمیمات فدرال رزرو',
    },
    section13_liquidityFlow: {
      flowBourse: '+1,420 میلیارد تومان',
      flowGoldFunds: '+145 میلیارد تومان',
      flowFixedIncome: '+480 میلیارد تومان (خروج به سمت سهام)',
      flowEquityFunds: '+320 میلیارد تومان',
      flowLeveragedFunds: '+185 میلیارد تومان',
      flowCrypto: '-35.0 میلیون دلار',
    },
  };
}
