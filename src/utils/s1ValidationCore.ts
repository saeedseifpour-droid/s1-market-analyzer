...
export function getDefault13SectionsData(): StandardDailyInput13Sections {
  ...
  return {
    ...
    section1_iranMacro: {
      usdFree: '191,200 تومان',
      usdYesterday: '189,200 تومان',
      usdChangePct: '+1.05%',
      usdt: '188,000 تومان',
      usdtYesterday: '186,400 تومان',
      usdtChangePct: '+0.86%',
      gold18k: '20,400,000 تومان',
      gold18kYesterday: '19,850,000 تومان',
      gold18kChangePct: '+2.77%',
      sekeEmami: '204,500,000 تومان',
      sekeYesterday: '199,500,000 تومان',
      sekeChangePct: '+2.50%',
      coinBubble: '2.7%',
    ...
    section3_crypto: {
      btcPrice: '77,276 دلار',
      btcYesterday: '77,350 دلار',
      btcChangePct: '-0.09%',
      ethPrice: '2,480 دلار',
      ethChangePct: '-0.45%',
      btcDominance: '57.8%',
      marketCap: '2.85 تریلیون دلار',
    ...
    section4_bourse: {
      tseIndex: '6,073,294 واحد',
      tseYesterday: '5,952,687 واحد',
      tseIndexChangePct: '+2.03%',
      tseEqualWeight: '1,717,903 واحد',
      tseEqualWeightChangePct: '+1.84%',
      retailVolume: '16,450 میلیارد تومان',
      realMoneyFlow: '+1,480 میلیارد تومان',
      positiveSymbolsCount: '588 نماد',
      negativeSymbolsCount: '184 نماد',
      buyQueueCount: '182 نماد',
      buyQueueValue: '13,800 میلیارد تومان',
      sellQueueCount: '26 نماد',
      sellQueueValue: '545 میلیارد تومان',
      marketNews: 'رکوردشکنی تاریخی بورس تهران و عبور پرقدرت شاخص کل از سقف ۶ میلیون واحد با ورود پرحجم نقدینگی حقیقی',
    },
    section5_afranFund: {
